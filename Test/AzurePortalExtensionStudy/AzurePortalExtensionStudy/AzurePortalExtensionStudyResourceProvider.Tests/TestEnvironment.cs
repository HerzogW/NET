...
namespace AzurePortalExtensionStudyResourceProvider.Tests
{
    using System;
    ...
    public static class TestEnvironment
    {
        ...
        /// The event database.
        /// </summary>
        public const string EventsDatabase = "Tests.AzurePortalExtensionStudyResourceProviderSample.Events";

        /// <summary>
        /// The config database.
        /// </summary>
        public const string ConfigDatabase = "Tests.AzurePortalExtensionStudyResourceProviderSample.Config";

        /// <summary>
        /// The usage database.
        /// </summary>
        public const string UsageDatabase = "Tests.AzurePortalExtensionStudyResourceProviderSample.Usage";
