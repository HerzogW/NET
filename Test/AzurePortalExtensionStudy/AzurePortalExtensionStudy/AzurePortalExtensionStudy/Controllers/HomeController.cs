...
namespace Microsoft.Portal.Extensions.AzurePortalExtensionStudy.Controllers
{
    /// <summary>
    /// Home controller
    /// </summary>
        ...
        protected override void OnActionExecuted(ActionExecutedContext filterContext)
        {
            ...
            {             
                ...
                var keepDebuggerAttached = string.Format(
                    "<script>window.open('{0}/?feature.customportal=false&feature.canmodifyextensions=true#?testExtensions={{\"AzurePortalExtensionStudy\":\"{1}\"}}');</script>",
