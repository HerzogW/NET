...
namespace AzurePortalExtensionStudyResourceProvider
{
    ...
    [EventSource(Name = "AzurePortalExtensionStudyResourceProvider", LocalizationResources = "AzurePortalExtensionStudyResourceProvider.ErrorHandling.TraceMessages")]
