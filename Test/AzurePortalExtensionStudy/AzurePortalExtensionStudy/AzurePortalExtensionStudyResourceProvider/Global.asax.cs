//-----------------------------------------------------------
// Copyright (c) AzurePortalExtensionStudyResourceProvider.  All rights reserved.
//-----------------------------------------------------------

namespace AzurePortalExtensionStudyResourceProvider
{
    using System;
    ...
    using AzurePortalExtensionStudyResourceProvider.ErrorHandling;

    /// <summary>
    /// The ResourceProviderApplication implementation
    /// </summary>
    public class AzurePortalExtensionStudyResourceProviderApplication : HttpApplication
    {
        /// <summary>
        ...
        protected void Application_Start()
        {
            ...
            serviceEventSource.ApplicationStarting(this.GetType().Name, AzurePortalExtensionStudyResourceProviderApplication.CurrentVersion);
                ...
                .TryGetConfiguration<ResourceProviderServiceConfiguration>(out serviceConfiguration, out exception))
            {
                ...
                AzurePortalExtensionStudyResourceProviderApplication.Initialize(
                    httpConfiguration: GlobalConfiguration.Configuration,
                    serviceConfiguration: serviceConfiguration,
                    eventSource: eventSource);

                serviceEventSource.ApplicationStarted(this.GetType().Name, AzurePortalExtensionStudyResourceProviderApplication.CurrentVersion);
            }
            else
            {
        ...
        {
            serviceEventSource.ApplicationEnding(this.GetType().Name, AzurePortalExtensionStudyResourceProviderApplication.CurrentVersion);
            ...
            serviceEventSource.ApplicationEnded(this.GetType().Name, AzurePortalExtensionStudyResourceProviderApplication.CurrentVersion);
        }
