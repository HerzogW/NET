...
interface JQueryPromiseN<TNotify> {
    ...
    then<UValue, UReject>(
        doneCallbacks: { (): UValue; },
        failCallbacks: { (): UReject; },
        progressCallbacks?: { (arg: TNotify): void; }): JQueryPromiseVR<UValue, UReject>;

    // U Pipe
    then(
        doneCallbacks: { (): JQueryDeferredN<TNotify>; },
        failCallbacks?: { (): void; },
        progressCallbacks?: { (): void; }): JQueryPromiseN<TNotify>;
    ...
    then<UValue>(
        doneCallbacks: { (): UValue; },
        failCallbacks?: { (): void; },
        progressCallbacks?: { (arg: TNotify): void; }): JQueryPromiseV<UValue>;

    then<UReject>(
        doneCallbacks: { (): void; },
        failCallbacks: { (): UReject; },
        progressCallbacks?: { (arg: TNotify): void; }): JQueryPromiseR<UReject>;

    then(
        doneCallbacks: { (): void; },
        failCallbacks?: { (): void; },
        progressCallbacks?: { (arg: TNotify): void; }): JQueryPromise;
}
...
interface JQueryPromiseNNNN<TNotify1, TNotify2, TNotify3, TNotify4> {
    ...
    progress(...progressCallbacks: Array<{ (arg1: TNotify1, arg2: TNotify2, arg3: TNotify3, arg4: TNotify4): void; }>): JQueryPromiseNNNN<TNotify1, TNotify2, TNotify3, TNotify4>;
    state(): string;
    promise(target?: any): JQueryPromiseNNNN<TNotify1, TNotify2, TNotify3, TNotify4>;
    then<UValue, UReject>(
        doneCallbacks: { (): UValue; },
        failCallbacks: { (): UReject; },
        progressCallbacks?: { (arg1: TNotify1, arg2: TNotify2, arg3: TNotify3, arg4: TNotify4): void; }): JQueryPromiseVR<UValue, UReject>;

    then<UValue>(
        doneCallbacks: { (): UValue; },
        failCallbacks?: { (): void; },
        progressCallbacks?: { (arg1: TNotify1, arg2: TNotify2, arg3: TNotify3, arg4: TNotify4): void; }): JQueryPromiseV<UValue>;

    then<UReject>(
        doneCallbacks: { (): void; },
        failCallbacks: { (): UReject; },
        progressCallbacks?: { (arg1: TNotify1, arg2: TNotify2, arg3: TNotify3, arg4: TNotify4): void; }): JQueryPromiseR<UReject>;

    then(
        doneCallbacks: { (): void; },
        failCallbacks?: { (): void; },
        progressCallbacks?: { (arg1: TNotify1, arg2: TNotify2, arg3: TNotify3, arg4: TNotify4): void; }): JQueryPromise;
}
...
interface JQueryPromiseVV<TValue1, TValue2> {
    ...
    then<UValue1, UValue2>(
        ...
        failCallbacks?: { (): void; },
        progressCallbacks?: { (): void; }): JQueryPromiseVV<UValue1, UValue2>;
...
interface JQueryPromiseVVV<TValue1, TValue2, TValue3> {
    ...
    done(...doneCallbacks: Array<{ (arg1: TValue1, arg2: TValue2, arg3: TValue3): void; }>): JQueryPromiseVVV<TValue1, TValue2, TValue3>;
    ...
    then<UValue1, UValue2, UValue3>(
        ...
        failCallbacks?: { (): void; },
        progressCallbacks?: { (): void; }): JQueryPromiseVVV<UValue1, UValue2, UValue3>;
...
interface JQueryPromiseVR<TValue, TReject> {
    ...
    then<UValue>(
        ...
        progressCallbacks?: { (): void; }): JQueryPromiseVR<UValue, TReject>;
...
interface JQueryPromiseVRN<TValue, TReject, TProgress> {
    ...
    then<UValue, UReject>(
        doneCallbacks: { (arg: TValue): UValue; },
        failCallbacks: { (arg: TReject): UReject; },
        progressCallbacks?: { (arg: TProgress): void; }): JQueryPromiseVR<UValue, UReject>;

    // U Pipe
    then<UValue>(
        doneCallbacks: { (arg: TValue): JQueryDeferredVRN<UValue, TReject, TProgress>; },
        failCallbacks?: { (arg: TReject): void; },
        progressCallbacks?: { (): void; }): JQueryPromiseVRN<UValue, TReject, TProgress>;
    ...
    then<UValue>(
        doneCallbacks: { (arg: TValue): UValue; },
        failCallbacks?: { (arg: TReject): void; },
        progressCallbacks?: { (arg: TProgress): void; }): JQueryPromiseV<UValue>;

    then<UReject>(
        doneCallbacks: { (arg: TValue): void; },
        failCallbacks: { (arg: TReject): UReject; },
        progressCallbacks?: { (arg: TProgress): void; }): JQueryPromiseR<UReject>;

    then(
        doneCallbacks: { (arg: TValue): void; },
        failCallbacks?: { (arg: TReject): void; },
        progressCallbacks?: { (arg: TProgress): void; }): JQueryPromise;
}
...
interface JQueryPromiseR<TReject> {
    ...
    then(
        ...
        failCallbacks?: { (arg: TReject): void; },
        progressCallbacks?: { (): void; }): JQueryPromiseR<TReject>;
...
interface JQueryDeferredNNNN<TNotify1, TNotify2, TNotify3, TNotify4> {
    notify(arg1: TNotify1, arg2: TNotify2, arg3: TNotify3, arg4: TNotify4): JQueryDeferredNNNN<TNotify1, TNotify2, TNotify3, TNotify4>;
    notifyWith(context: any, arg1: TNotify1, arg2: TNotify2, arg3: TNotify3, arg4: TNotify4): JQueryDeferredNNNN<TNotify1, TNotify2, TNotify3, TNotify4>;
    ...
    progress(...progressCallbacks: Array<{ (arg1: TNotify1, arg2: TNotify2, arg3: TNotify3, arg4: TNotify4): void; }>): JQueryDeferredNNNN<TNotify1, TNotify2, TNotify3, TNotify4>;
    promise(target?: any): JQueryPromiseNNNN<TNotify1, TNotify2, TNotify3, TNotify4>;
...
interface JQueryDeferredVVV<TValue1, TValue2, TValue3> {
    ...
    done(...doneCallbacks: Array<{ (arg1: TValue1, arg2: TValue2, arg3: TValue3): void; }>): JQueryDeferredVVV<TValue1, TValue2, TValue3>;
...
interface JQueryDeferredVRN<TValue, TReject, TNotify> {
    ...
    then<UValue>(
        ...
        failCallbacks?: { (arg: TReject): void; },
        progressCallbacks?: { (): void; }): JQueryPromiseVRN<UValue, TReject, TNotify>;
...
interface JQueryWhen {
    ...
    <T1, T2, T3>(promise1: JQueryPromiseV<T1>, promise2: JQueryPromiseV<T2>, promise3: JQueryPromiseV<T3>): JQueryPromiseVVV<T1, T2, T3>;
