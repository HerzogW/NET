...
namespace AzurePortalExtensionResourceProvider.Tests
{
    using System;
    ...
    public static class TestEnvironment
    {
        ...
        /// The event database.
        /// </summary>
        public const string EventsDatabase = "Tests.AzurePortalExtensionResourceProviderSample.Events";

        /// <summary>
        /// The config database.
        /// </summary>
        public const string ConfigDatabase = "Tests.AzurePortalExtensionResourceProviderSample.Config";

        /// <summary>
        /// The usage database.
        /// </summary>
        public const string UsageDatabase = "Tests.AzurePortalExtensionResourceProviderSample.Usage";
