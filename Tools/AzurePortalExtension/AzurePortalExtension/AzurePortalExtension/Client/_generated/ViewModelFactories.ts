...
module ViewModelFactories {
    ...
    export class ResourceViewModelFactoriesBase extends FxImpl.Extension.ViewModelAreaFactoriesBase<Resource.DataContext> implements ExtensionDefinition.ResourceViewModelFactories,ExtensionDefinition.ResourceDataContextContainer {
        ...
        public CreateBladeViewModel(container: MsPortalFx.ViewModels.ContainerContract, initialState?: any): MsPortalFx.Base.PromiseV<ExtensionDefinition.Resource$CreateBladeViewModel$Contract> {
    ...
    export class ViewModelFactoriesBase implements ExtensionDefinition.ViewModelFactories {
        ...
        public Resource$CreateBladeViewModel(container: MsPortalFx.ViewModels.ContainerContract, initialState?: any): MsPortalFx.Base.PromiseV<ExtensionDefinition.Resource$CreateBladeViewModel$Contract> {
