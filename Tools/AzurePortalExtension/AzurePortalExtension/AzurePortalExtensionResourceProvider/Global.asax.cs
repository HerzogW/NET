...
namespace AzurePortalExtensionResourceProvider
{
    ...
    using AzurePortalExtensionResourceProvider.ErrorHandling;

    /// <summary>
    /// The ResourceProviderApplication implementation
    /// </summary>
    public class AzurePortalExtensionResourceProviderApplication : HttpApplication
    {
        /// <summary>
        ...
        protected void Application_Start()
        {
            ...
            serviceEventSource.ApplicationStarting(this.GetType().Name, AzurePortalExtensionResourceProviderApplication.CurrentVersion);
                ...
                .TryGetConfiguration<ResourceProviderServiceConfiguration>(out serviceConfiguration, out exception))
            {
                ...
                AzurePortalExtensionResourceProviderApplication.Initialize(
                    httpConfiguration: GlobalConfiguration.Configuration,
                    serviceConfiguration: serviceConfiguration,
                    eventSource: eventSource);

                serviceEventSource.ApplicationStarted(this.GetType().Name, AzurePortalExtensionResourceProviderApplication.CurrentVersion);
            }
            else
            {
        ...
        {
            serviceEventSource.ApplicationEnding(this.GetType().Name, AzurePortalExtensionResourceProviderApplication.CurrentVersion);
            ...
            serviceEventSource.ApplicationEnded(this.GetType().Name, AzurePortalExtensionResourceProviderApplication.CurrentVersion);
        }
