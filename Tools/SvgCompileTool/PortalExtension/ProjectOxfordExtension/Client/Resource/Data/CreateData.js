 ...
 */
"use strict";
define(["require", "exports", "ClientResources", "../../_generated/Svg", "../../_generated/SvgLogo", "../../Shared/Constants"], function (require, exports, ClientResources, Svg, SvgLogo, Constants) {
    var SvgContent = Svg.Content.SVG;
    var SvgLogoContent = SvgLogo.Content.SVG;
        ...
        CreateData.prototype.getSpecData = function (apiType) {
            switch (apiType) {
                ...
                case (Constants.ApiTypes.Recommendations):
                    return {
                        "specType": "Microsoft.CognitiveServices/recommendationsApi",
                        "specs": [
                            {
                                "id": "F0",
                                "colorScheme": "mediumBlue",
