...
// Modified: Azure Framework <http://www.azure.com>
...
interface KnockoutBindingHandler {
    init? (element: any, valueAccessor: () => any, allBindingsAccessor: () => any, viewModel: any, bindingContext: KnockoutBindingContext): any;
    update? (element: any, valueAccessor: () => any, allBindingsAccessor: () => any, viewModel: any, bindingContext: KnockoutBindingContext): any;
    options?: any;
}
...
interface KnockoutUtils {
    ...
    compareArrays<T>(oldArray: T[], newArray: T[], dontLimitMoves?: boolean|KnockoutCompareArrayOptions): KnockoutArrayEdit<T>[];
...
interface KnockoutVirtualElements {
    ...
    insertBeforeHelper: (containerNode: Element, nodeToInsert: Node, insertAfterNod: Node) => Node;
}

interface KnockoutTemplateRewriting {
    ensureTemplateIsRewritten(template: string, templateEngine: ko.templateEngine, templateDocument?: Document): void;
    ensureTemplateIsRewritten(template: Element, templateEngine: ko.templateEngine, templateDocument?: Document): void;
    memoizeBindingAttributeSyntax(htmlString: string, templateEngine: ko.templateEngine): string;
...
interface KnockoutComponents {
    register(componentName: string, configuration: KnockoutComponentConfig): void;
    isRegistered(componentName: string): boolean;
    unregister(componentName: string): void;
    get(componentName: string, callback: (configuration: KnockoutComponentConfig) => void): void;
...
interface KnockoutComponentCreateViewModelFactory {
    (params: any, options: { element: Node; }): any;
}

interface KnockoutComponentConfigViewModel {
    new? (params: any): any;
    createViewModel?: KnockoutComponentCreateViewModelFactory;
    require?: string;
    instance?: any;
}
...
interface KnockoutComponentLoader {
    ...
    loadComponent? (componentName: string, config: KnockoutComponentConfig, callback: (result: KnockoutComponentConfig) => void): void;
    loadTemplate? (componentName: string, templateConfig: any, callback: (result: Node[]) => void): void;
    loadViewModel? (componentName: string, viewModelConfig: any, callback: (result: KnockoutComponentCreateViewModelFactory) => void): void;
...
declare module ko {
    ...
    export var components: KnockoutComponents;
    
    export function unwrap<T>(value: T | KnockoutObservableBase<T>): T;
    ...
    export var pureComputed: KnockoutPureComputedStatic;
    ...
    export function ignoreDependencies<T>(callback: () => T, callbackTarget?: any, callbackArgs?: any[]): T;
    ...
    export function isWritableObservable(instance: any): boolean;
    export function isComputed(instance: any): boolean;
    export function isPureComputed(instance: any): boolean;
